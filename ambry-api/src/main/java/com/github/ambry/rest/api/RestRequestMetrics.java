 ...
 */
package com.github.ambry.rest.api;
...
public class RestRequestMetrics {
  public static final String NIO_REQUEST_PROCESSING_TIME_SUFFIX = "NioRequestProcessingTimeInMs";
  public static final String NIO_RESPONSE_PROCESSING_TIME_SUFFIX = "NioResponseProcessingTimeInMs";
  static final String NIO_ROUND_TRIP_TIME_SUFFIX = "NioRoundTripTimeInMs";

  public static final String SC_REQUEST_PROCESSING_TIME_SUFFIX = "ScRequestProcessingTimeInMs";
  public static final String SC_REQUEST_PROCESSING_WAIT_TIME_SUFFIX = "ScRequestProcessingWaitTimeInMs";
  public static final String SC_RESPONSE_PROCESSING_TIME_SUFFIX = "ScResponseProcessingTimeInMs";
  public static final String SC_RESPONSE_PROCESSING_WAIT_TIME_SUFFIX = "ScResponseProcessingWaitTimeInMs";
  public static final String SC_ROUND_TRIP_TIME_SUFFIX = "ScRoundTripTimeInMs";

  public static final String OPERATION_RATE_SUFFIX = "Rate";
  public static final String OPERATION_ERROR_SUFFIX = "Error";
